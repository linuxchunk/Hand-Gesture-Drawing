...
# Streamlit app
st.set_page_config(page_title="Hand Drawing Tool", page_icon=":pencil2:", layout="wide")

def main():
    st.title("Hand Drawing Tool")
    st.sidebar.title("Toolbox")

    app_mode = st.sidebar.selectbox("Select the app mode",
                                    ["Instructions", "Run the app"])

    if app_mode == "Instructions":
        st.write("This app allows you to draw using your hands. "
                 "Please select 'Run the app' to start the drawing tool.")
